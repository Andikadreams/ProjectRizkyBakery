...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form class="form-left my-2"
            method="get" action="{{ route('kategori.search') }}">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    @if ($tmp != 1)
                        <td>{{ $row->nama }}</td>
                        <td>
                            <a href="{{ route('kategori.edit', $row->id) }}" class="btn btn-warning" onclick="confirmationEdit(event)">Edit</a>
                            <a href="{{ route('kategori.destroy', $row->id) }}" class="btn btn-danger" onclick="confirmationDel(event)">Hapus</a>
                        </td>
                        @endif
                    </tr>
                    @endforeach
