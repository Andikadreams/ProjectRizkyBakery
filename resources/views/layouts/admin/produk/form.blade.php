            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" required="required" class="form-control" id="kode_produk" name="kode_produk"
                            value="{{ isset($produk) ? $produk->kode_produk : '' }}">
                    </div>
                    <div class="form-group">
                        <label for="nama_produk">Nama Produk</label>
                        <input type="text" required="required" class="form-control" id="nama_produk" name="nama_produk"
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_kategori" id="id_kategori" class="custom-select" required="required">
